...
//    private static final String SECURED_PATTERN = "/api/**";
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .antMatcher("/**")
                .authorizeRequests()
                    .antMatchers("/","/showFile/**","/v1/showFile/**","/v1/upload", "/user-register/**","/forget-password/**", "/oauth/authorize**", "/login**", "/error**", "/swagger-ui/**","/swagger-ui.html","/v1/binar/barang/**", "/v3/api-docs/**")
                    .permitAll()
